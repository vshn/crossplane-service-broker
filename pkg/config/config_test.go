	...
	tt := map[string]struct {
		...
		"username claim given": {
			...
			config: &Config{
				...
				MariaDBService:         "mariadb-k8s",
				MariaDBDatabaseService: "mariadb-k8s-database",
				RedisService:           "redis-k8s",
			},
			err: "",
		},
		"service name given": {
			env: map[string]string{
				...
				EnvNamespace:              "test",
				EnvUsernameClaim:          "different than default",
				EnvMariaDBService:         "mariadb-cluster",
				EnvMariaDBDatabaseService: "mariadb-database",
				EnvRedisService:           "redis-cluster",
			},
			config: &Config{
				ServiceIDs:             []string{"1", "2", "3"},
				ListenAddr:             ":8080",
				...
				JWKeyRegister:          &jwt.KeyRegister{},
				PlanUpdateSLARule:      defaultSLAUpdateRules,
				MariaDBService:         "mariadb-cluster",
				MariaDBDatabaseService: "mariadb-database",
